...
df = pd.read_csv('./data/ground/paper_dic24/salto_termico_18-12.csv')
lookup = pd.read_csv('./data/config/params/lookup_cell_1exp-salto_termico_nuovo.csv')
