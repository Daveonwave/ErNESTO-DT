...
def get_args():
    ...
    def get_adaptive_args():
        ...
        adaptive_parser.add_argument("--batch_size", type=int,
                                     help="Specifies the size of the batch (window) used to perform an optimization of parameters.")
        
        adaptive_parser.add_argument("--algorithm", type=str,
                                     help="Specifies the optimizer algorithm adopted.")
        
        adaptive_parser.add_argument("--n_jobs", default=1, type=int,
                                     help="Specifies the number of processes for each optimization step.")
        
        adaptive_parser.add_argument("--n_guesses", default=1, type=int,
                                     help="Specifies the number of initial guesses for each optimization step.")
        
        adaptive_parser.add_argument("--enable_adaptation", action='store_true', default=False, 
    ...
    def get_generic_args():
        ...
        main_parser.add_argument("--profiler", action='store_true', default=False,
