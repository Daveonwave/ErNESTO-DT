# -*- coding: utf-8 -*-
#
# BESS_DigitalTwin documentation build config file, created by
# sphinx-quickstart.
#
# This file is execfile()d with the current directory set to its containing dir.
#
# Note that not all possible config values are present in this
# autogenerated file.
#
# All config values have a default; values that are commented out
...
latex_documents = [
    ('index',
     'DT-rse.tex',
     u'BESS_DigitalTwin Documentation',
     u"Davide Salaorni", 'manual'),
]
...
texinfo_documents = [
    ('index', 'DT-rse', u'BESS_DigitalTwin Documentation',
     u"Davide Salaorni", 'BESS_DigitalTwin',
     'Digital Twin of a Battery Energy Storage System', 'Miscellaneous'),
]
